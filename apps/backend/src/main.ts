...
import {AppModule} from "@crosspublic/backend/src/app.module";
import cookieParser from 'cookie-parser';
import {SubscriptionExceptionFilter} from "@crosspublic/backend/src/services/authorization/subscription.exception";
import morgan from 'morgan';
import {ResponseInterceptor} from "@crosspublic/backend/src/services/response.interceptor";
import * as process from "process";
import {loadSwagger} from "@crosspublic/helpers/src/swagger/load.swagger";
