---
title: Introduction
description: 'Welcome to MeetFAQ documentation'
---
...
## Architecture
MeetFAQ is an [NX monorepo](https://nx.dev) that contains the backend, control panel, discord bot, marketing website and the docs.<br /><br />
...
- `Website` - NextJS control panel to manage your FAQ, it also contains the public website of every user FAQ page.
